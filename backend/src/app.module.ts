...
@Module({
  ...
  // EventEmitterModule.forRoot() is registered globally, once, here at the
  // root — this is what lets ChatGateway and NotificationsService talk to
  // each other WITHOUT importing each other's module directly, breaking
